...
export const INTEGRATIONS = [
  ...
  },
  {
    ...
    icon: 'calendar',
    color: '#006BFF',
    blurb: 'Pull your scheduled meetings in and book borrowers without the back-and-forth.',
    perms: ['Read your profile', 'Read scheduled events'],
    accountKind: 'email',
    defaultAccount: 'julene@mslending.net',
  },
  {
    ...
    icon: 'penTool',
    color: '#00C4CC',
    blurb: 'See your Canva designs and marketing assets alongside the rest of your pipeline.',
    perms: ['Read your designs', 'Read assets & profile'],
    accountKind: 'email',
    defaultAccount: 'julene@fidelitymort.com',
  },
  {
    id: 'tiktok',
    name: 'TikTok',
    ...
    icon: 'megaphone',
    color: '#FE2C55',
    blurb: 'Track your TikTok videos and their views, likes, and comments from one place.',
    perms: ['Read your profile', 'Read your videos & metrics'],
    accountKind: 'handle',
    defaultAccount: '@julenestewartmsmortgages',
  },
  {
    id: 'reddit',
    name: 'Reddit',
    ...
    icon: 'messageCircle',
    color: '#FF4500',
    blurb: 'Connect your Reddit account to see your posts and activity in the workspace.',
    perms: ['Read your identity', 'Read your post history'],
    accountKind: 'handle',
    defaultAccount: 'MortgageBrokerMS',
  },
  {
    id: 'yelp',
    name: 'Yelp',
    ...
    icon: 'mapPin',
    color: '#D32323',
    blurb: 'Surface your Yelp rating and recent review excerpts as social proof.',
    perms: ['Read business details', 'Read review excerpts'],
    accountKind: 'account',
    defaultAccount: 'MS Lending — Julene S.',
  },
